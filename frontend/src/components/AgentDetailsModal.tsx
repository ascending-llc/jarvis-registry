    ...
    <div className='fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50'>
      <div className='bg-[var(--jarvis-card)] bg-[var(--jarvis-card)] rounded-xl p-6 max-w-4xl w-full mx-4 max-h-[80vh] overflow-auto'>
        <div className='flex items-center justify-between mb-4'>
          <h3 className='text-lg font-semibold text-[var(--jarvis-text-strong)] text-[var(--jarvis-text-strong)]'>
        ...
        <div className='space-y-4'>
          ...
          <div className='space-y-2'>
            <div className='flex items-center justify-between'>
              <h4 className='font-medium text-[var(--jarvis-text-strong)] text-[var(--jarvis-text-strong)]'>
                Agent JSON Schema:
              </h4>
              <button
                onClick={handleCopy}
          ...
          <div className='bg-[var(--jarvis-bg)] bg-[var(--jarvis-card)] border border-[color:var(--jarvis-border)] rounded-lg p-4'>
            <h4 className='font-medium text-[var(--jarvis-text-strong)] text-[var(--jarvis-text-strong)] mb-3'>
              Field Reference
            </h4>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4 text-sm'>
              <div>
                ...
                <ul className='space-y-1 text-[var(--jarvis-muted)] text-[var(--jarvis-muted)]'>
                  <li>
                    <code className='bg-[var(--jarvis-card-muted)] bg-[var(--jarvis-card-muted)] px-1 rounded'>
                      protocol_version
                    </code>{' '}
              ...
              <div>
                <h5 className='font-medium text-[var(--jarvis-text)] text-[var(--jarvis-text)] mb-2'>
                  Metadata Fields
                </h5>
                <ul className='space-y-1 text-[var(--jarvis-muted)] text-[var(--jarvis-muted)]'>
                  <li>
