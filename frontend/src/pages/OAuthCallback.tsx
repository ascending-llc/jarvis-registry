      ...
      <AuthPageLayout>
        <div className='card p-10 max-w-md w-full text-center animate-slide-up'>
          ...
          <div className='text-xs text-[var(--jarvis-muted)] text-[var(--jarvis-muted)] mt-6 pt-6 border-t border-[color:var(--jarvis-border)] border-[color:var(--jarvis-border)]'>
            ...
            <p className='mt-2'>
              Error Code:{' '}
              <code className='bg-[var(--jarvis-card-muted)] bg-[var(--jarvis-card)] px-2 py-1 rounded'>{error}</code>
            </p>
          </div>
        </div>
      </AuthPageLayout>
  ...
  return (
    <AuthPageLayout>
      <div className='card p-10 max-w-md w-full text-center animate-slide-up'>
        ...
        <h1 className='text-3xl font-semibold text-[var(--jarvis-text-strong)] text-[var(--jarvis-text-strong)] mb-6'>
