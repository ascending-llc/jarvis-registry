...
const STATUS_STYLE: Record<string, { pill: string; dot: string; label: string }> = {
  active: {
    pill: 'bg-[var(--jarvis-surface)] text-[var(--jarvis-success-text)]',
    dot: 'bg-[var(--jarvis-success)]',
    label: 'Active',
  },
  inactive: {
    pill: 'bg-[var(--jarvis-warning-soft)] text-[var(--jarvis-warning-text)]',
    dot: 'bg-[var(--jarvis-warning)]',
    label: 'Inactive',
  },
  error: {
    pill: 'bg-[var(--jarvis-surface)] text-[var(--jarvis-danger-text)]',
    dot: 'bg-[var(--jarvis-danger)]',
    label: 'Error',
  },
};
...
const getStatusStyle = (status?: string) =>
  STATUS_STYLE[status ?? ''] ?? {
    pill: 'bg-[var(--jarvis-surface)] text-[var(--jarvis-warning-text)]',
    dot: 'bg-[var(--jarvis-warning)]',
    label: 'Unknown',
  };
