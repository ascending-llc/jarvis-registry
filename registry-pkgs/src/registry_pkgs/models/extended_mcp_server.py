...
class ExtendedMCPServer(MCPServer):
    ...
    #
    # normalizedServerName: str is also inherited as required, matching Mongoose's
    # `required: true` — every environment has been backfilled (scripts/backfill_mcp_server_normalized_names.py)
